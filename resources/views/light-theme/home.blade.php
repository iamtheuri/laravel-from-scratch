...
@include('light-theme.partials.navbar')
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <p class="text-primary text-uppercase mb-2">About</p>
                        <h1 class="display-6 mb-4">Creative And Professional Photographer</h1>
                        <p>Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                        <p>Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                        <div class="row g-2 mb-4">
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-3"></i>Quality <Picture></Picture>
                            </div>
                            <div class="col-sm-6">
    ...
    <div class="container-xxl px-0 py-5">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <p class="text-primary text-uppercase mb-2">What We Offer</p>
            <h1 class="display-6 mb-0">Creative Photograhy</h1>
        </div>
        <div class="row g-0">
                ...
                <div class="row g-0 flex-sm-row">
                    ...
                    <div class="col-sm-6">
                        <div class="h-100 p-5 d-flex flex-column justify-content-between">
                            ...
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure suscipit ducimus earum minus ab a quos explicabo facilis et! Accusantium eius tempore, et earum aliquam asperiores architecto veniam error perferendis!</p>
